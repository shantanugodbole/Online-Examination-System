...
-- @authors : Shantanu Godbole, Anjali Gohil, Jugal Chauhan
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2020 at 08:27 AM
-- Server version: 10.4.11-MariaDB
-- PHP Version: 7.4.1

-- create a database with the name "project" and then copy paste the sql commands 
...
-- we collaborated for this project which is an assignment of our course 'mini project' at KJSCE
